...
namespace tEST23 {
	...
	/// <summary>
	/// Summary for TesteForm
	/// </summary>
	public ref class TesteForm : public System::Windows::Forms::Form
	{
	public:
		TesteForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(TesteForm::typeid));
			...
			this->gunaGradientTileButton1->Click += gcnew System::EventHandler(this, &TesteForm::gunaGradientTileButton1_Click);
			// 
			// PredictiePanel
			// 
			...
			this->gunaLabel5->Location = System::Drawing::Point(182, 40);
			this->gunaLabel5->Name = L"gunaLabel5";
			this->gunaLabel5->Size = System::Drawing::Size(689, 28);
			this->gunaLabel5->TabIndex = 17;
			this->gunaLabel5->Text = L"Rata de testare pentru depistarea infectării cu virusul SARS COV-2  în România";
			this->gunaLabel5->Click += gcnew System::EventHandler(this, &TesteForm::gunaLabel5_Click);
			// 
			// TesteForm
			// 
			...
			this->Name = L"TesteForm";
			this->Text = L"TesteForm";
...
#pragma endregion
	...
	private:
		void HidePredictie()
		{
			tEST23::TesteForm::PredictiePanel->Visible = false;
		}

		void ShowPredictie()
		{
			tEST23::TesteForm::PredictiePanel->Visible = true;
		}
	...
	private:
		void GenerateGraph()
		{
			...
			Predictie1::Predictie_teste obiect;
...
private: System::Void gunaLabel5_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
}
