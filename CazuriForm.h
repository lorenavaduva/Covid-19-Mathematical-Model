...
namespace tEST23 {
	...
	/// <summary>
	/// Summary for CazuriForm
	/// </summary>
	public ref class CazuriForm : public System::Windows::Forms::Form
	{
	public:
		CazuriForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(CazuriForm::typeid));
			...
			this->gunaGradientTileButton1->Click += gcnew System::EventHandler(this, &CazuriForm::gunaGradientTileButton1_Click);
			// 
			// CazuriPanel
			// 
			...
			this->PredictiePanel->TabIndex = 14;
			// 
			// gunaTextBox3
			// 
			...
			this->gunaTextBox3->Size = System::Drawing::Size(214, 36);
			...
			this->gunaTextBox2->Size = System::Drawing::Size(214, 36);
			...
			this->gunaTextBox1->Size = System::Drawing::Size(214, 36);
			...
			this->gunaLabel5->Location = System::Drawing::Point(307, 33);
			this->gunaLabel5->Name = L"gunaLabel5";
			this->gunaLabel5->Size = System::Drawing::Size(466, 28);
			this->gunaLabel5->TabIndex = 15;
			this->gunaLabel5->Text = L"Rata de infectare cu virusul SARS COV-2  în România";
			// 
			// CazuriForm
			// 
			...
			this->Name = L"CazuriForm";
			this->Text = L"CazuriForm";
...
#pragma endregion
	...
	private:
		void GenerateGraph()
		{
			...
			Predictie1::Predictie_cazuri obiect;
	...
	private:
		void HidePredictie()
		{
			tEST23::CazuriForm::PredictiePanel->Visible = false;
		}

		void ShowPredictie()
		{
			tEST23::CazuriForm::PredictiePanel->Visible = true;
		}
