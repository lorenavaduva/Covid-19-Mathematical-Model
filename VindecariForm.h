...
namespace tEST23 {
	...
	/// <summary>
	/// Summary for VindecariForm
	/// </summary>
	public ref class VindecariForm : public System::Windows::Forms::Form
	{
	public:
		VindecariForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(VindecariForm::typeid));
			...
			this->CazuriPanel->Location = System::Drawing::Point(42, 388);
			...
			this->gunaLabel1->Location = System::Drawing::Point(33, 19);
			...
			this->gunaGradientTileButton1->Click += gcnew System::EventHandler(this, &VindecariForm::gunaGradientTileButton1_Click);
			// 
			// PredictiePanel
			// 
			...
			this->PredictiePanel->Location = System::Drawing::Point(426, 388);
			...
			this->gunaTextBox3->Location = System::Drawing::Point(308, 113);
			this->gunaTextBox3->Name = L"gunaTextBox3";
			this->gunaTextBox3->PasswordChar = '\0';
			this->gunaTextBox3->SelectedText = L"";
			this->gunaTextBox3->Size = System::Drawing::Size(216, 36);
			...
			this->gunaTextBox2->Location = System::Drawing::Point(308, 65);
			this->gunaTextBox2->Name = L"gunaTextBox2";
			this->gunaTextBox2->PasswordChar = '\0';
			this->gunaTextBox2->SelectedText = L"";
			this->gunaTextBox2->Size = System::Drawing::Size(216, 36);
			...
			this->gunaTextBox1->Size = System::Drawing::Size(216, 36);
			...
			this->gunaLabel5->Location = System::Drawing::Point(234, 32);
			this->gunaLabel5->Name = L"gunaLabel5";
			this->gunaLabel5->Size = System::Drawing::Size(609, 28);
			this->gunaLabel5->TabIndex = 16;
			this->gunaLabel5->Text = L"Rata de vindecare a celor afectați de virusul SARS COV-2  în România";
			// 
			// VindecariForm
			// 
			...
			this->Name = L"VindecariForm";
			this->Text = L"VindecariForm";
...
#pragma endregion
    ...
    private:
		void HidePredictie()
		{
			tEST23::VindecariForm::PredictiePanel->Visible = false;
		}

		void ShowPredictie()
		{
			tEST23::VindecariForm::PredictiePanel->Visible = true;
		}
		...
		void GenerateGraph()
			{
				...
				Predictie1::Predictie_vindecari obiect;
